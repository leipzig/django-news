...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.markup_filter'
        db.delete_column(u'news_article', 'markup_filter')


    def backwards(self, orm):
        # Adding field 'Article.markup_filter'
        db.add_column(u'news_article', 'markup_filter',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=32, null=True, blank=True),
                      keep_default=False)
